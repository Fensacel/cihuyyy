    ...
    <div class="rounded-2xl bg-white/95 backdrop-blur-sm shadow-2xl p-8">
        ...
        <div class="flex rounded-xl bg-gray-100 p-1 mb-6">
            <button type="button" onclick="switchTab('siswa')" id="tab-siswa"
                    class="flex flex-1 items-center justify-center gap-2 rounded-lg py-2 text-sm font-semibold transition-all bg-white text-gray-900 shadow-sm">
            ...
            <button type="button" onclick="switchTab('staff')" id="tab-staff"
                    class="flex flex-1 items-center justify-center gap-2 rounded-lg py-2 text-sm font-semibold transition-all text-gray-500">
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
