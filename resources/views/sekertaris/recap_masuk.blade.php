<x-layouts.app title="Rekapan Absensi - Masuk">
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 print:hidden">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Rekap Absensi Masuk</h1>
    ...
    <div class="hidden print:block mb-6">
        <h1 class="text-xl font-bold text-gray-900">Rekap Absensi Masuk</h1>
